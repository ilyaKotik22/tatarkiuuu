...
const mapSongs = new Map([
    [1, "Уфтанма"],
    [2, "Әлдермешкә кайтам әле"],
    [3, "Яшьлегем чишмәләре"],
    [4, "Бәхеттә, шатлыкта"],
    [5, "Әйдә, сандугач"],
    [6, "Чияләр"],
...
class MusicLotoBot {
    ...
    async sendRoundMessages(lobby) {
        // Выбираем правильный файл в зависимости от режима
...
// Запуск бота
const token = "8240678426:AAEa1Ye7ZApAOv6p-XIaF4eefdHmMKGLvso"; // Лучше через process.env.TELEGRAM_BOT_TOKEN
